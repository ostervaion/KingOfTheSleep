...
## 2.1 Other Instructions:
- You can create a development deployment (with hot updates) by running **make build** followed by **make up**. Use make open-http to automatically open the website in your browser.
