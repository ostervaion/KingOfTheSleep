    ...
    <div v-show="expanded" class="px-4 pb-4 sm:px-6 sm:pb-5 md:px-8">
      <div class="grid gap-4 lg:grid-cols-[minmax(0,1fr)_220px] lg:gap-6">
        <div class="min-w-0">
          ...
          <div v-if="props.enemy_stats" class="space-y-2">
            <div
              v-for="stat in stats"
              :key="stat.key"
            ...
            >
              ...
              <div class="relative h-2 overflow-hidden rounded-full bg-white/10">
                <div
                  ...
                  :style="{
                    width: `${getBarWidth(getPlayerValue(stat.key), getEnemyValue(stat.key))}%`,
                  }"
                />
                ...
                <div
                  ...
                  :style="{
                    width: `${getBarWidth(getEnemyValue(stat.key), getPlayerValue(stat.key))}%`,
                  }"
                />
        ...
        <aside class="min-w-0">
          ...
          <div class="space-y-2 text-xs leading-relaxed text-zinc-400">
            <p>
              <span class="font-medium text-white"> {{ playerName }}: </span>
            ...
            <p>
              <span class="font-medium text-white"> {{ props.enemy_username }}: </span>
          ...
          >
            <p class="mb-2 text-xs text-zinc-400">Score</p>
