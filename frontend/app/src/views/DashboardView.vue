...
<template>
  <div class="h-[calc(100dvh-64px)] text-(--text) px-4 py-4 sm:px-6 lg:px-8 overflow-hidden flex flex-col gap-3">
    <NextBattle />

    <div class="mx-auto grid w-full flex-1 min-h-0 gap-4 lg:grid-cols-[1fr_1.2fr_1.2fr] items-stretch">
